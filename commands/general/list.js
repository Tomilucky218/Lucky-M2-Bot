        ...
        buttons: [
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.youtube || 'http://youtube.com/@LUCKYTECHHUB'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: config.social?.github || 'https://github.com/Tomilucky218'
            })
          },
          {
            name: 'cta_url',
            buttonParamsJson: JSON.stringify({
              ...
              url: 'https://whatsapp.com/channel/0029VbAnuvT6RGJ9Qrf3NJ0L'
            })
          }
        ]
      }, { quoted: msg });
